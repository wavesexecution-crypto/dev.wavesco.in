...
export function ProjectModal({
  ...
  return (
    <div
      className="animate-fade-in fixed inset-0 z-[80] flex items-end justify-center bg-black/70 p-0 backdrop-blur-sm sm:items-center sm:p-6"
      onClick={onClose}
      role="dialog"
      aria-modal="true"
    ...
    >
      <div
        className="animate-scale-in max-h-[92dvh] w-full max-w-3xl overflow-y-auto rounded-t-2xl border border-line bg-surface sm:rounded-2xl"
